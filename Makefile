...
load-data-goadV2 : 
	...
	python3 bloodhound-automation.py data -z ./data/goadV2/SEVENKINGDOMS_20240410083609_BloodHound-2.3.3.zip my_project
load-data-bloodhound-example-data : 
	python3 bloodhound-automation.py data -z ./data/BloodHound_example_data/ad_example_data.zip my_project
delete-project : 
